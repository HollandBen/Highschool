...
class movable(pygame.sprite.Sprite):
    ...
    def move(self):
        ...
        movex = (key_input[pygame.K_a] * -self.speed) + (key_input[pygame.K_d] * self.speed) #speed -> self.speed
        movey = (key_input[pygame.K_w] * -self.speed) + (key_input[pygame.K_s] * self.speed)

        #x-location + x-speed = new x-location
        self.rect.x += movex # make these act on self
